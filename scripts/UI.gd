...
func resetUI():
	$Rooms/Home.texture = load("res://assets/Scenes/1a home.jpg")
	$Rooms/Transit.texture = load("res://assets/Scenes/2a transit.jpg")
	$Rooms/Police.texture = load("res://assets/Scenes/3a police.jpg")
	$Rooms/Beach.texture = load("res://assets/Scenes/4a beach.jpg")
	$Rooms/Mansion.texture = load("res://assets/Scenes/5a mansion.jpg")
	$Rooms/Attic.texture = load("res://assets/Scenes/1b attic.jpg")
	$Rooms/Library.texture = load("res://assets/Scenes/2b library.jpg")
	$Rooms/Evidence.texture = load("res://assets/Scenes/3b evidence.jpg")
	$Rooms/Shack.texture = load("res://assets/Scenes/4b shack.jpg")
	$Rooms/Rotunda.texture = load("res://assets/Scenes/5b rotunda.jpg")
